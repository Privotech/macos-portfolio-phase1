...
const SkillsApp = () => {
  ...
  return (
    <div className="w-full h-full bg-[#1e1e1e] p-8 overflow-y-auto scrollbar-macos">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-white mb-8 border-b border-white/10 pb-4">Technical Proficiencies</h1>
