    ...
    <div className="w-full h-full flex flex-col bg-[#1e1e1e] text-[#cccccc] font-sans selection:bg-[#264f78]">
        ...
        <div className="w-12 bg-[#333333] flex flex-col items-center py-2 flex-shrink-0 justify-between">
          <div className="flex flex-col w-full">
            <div
              onClick={() =>
                setActiveSidebar(
                  activeSidebar === "explorer" ? null : "explorer",
                )
              }
              className={`w-full aspect-square flex items-center justify-center cursor-pointer ${activeSidebar === "explorer" ? "border-l-2 border-blue-500 text-white" : "border-l-2 border-transparent text-[#858585] hover:text-white"}`}
            >
            ...
            <div
              ...
              className={`w-full aspect-square flex items-center justify-center cursor-pointer ${activeSidebar === "search" ? "border-l-2 border-blue-500 text-white" : "border-l-2 border-transparent text-[#858585] hover:text-white"}`}
            >
              <VscSearch className="text-[24px]" />
            </div>
            <div
              onClick={() =>
                setActiveSidebar(activeSidebar === "git" ? null : "git")
              }
              className={`w-full aspect-square flex items-center justify-center cursor-pointer ${activeSidebar === "git" ? "border-l-2 border-blue-500 text-white" : "border-l-2 border-transparent text-[#858585] hover:text-white"}`}
            >
              <VscSourceControl className="text-[24px]" />
            </div>
            <div
              className={`w-full aspect-square flex items-center justify-center cursor-pointer border-l-2 border-transparent text-[#858585] hover:text-white`}
            >
        ...
        {activeSidebar && (
          <div className="w-[250px] bg-[#252526] flex flex-col flex-shrink-0">
            ...
            {activeSidebar === "search" && (
              <div className="p-4">
                <div className="text-[11px] uppercase font-medium tracking-wide mb-4">
                  Search
                </div>
                <input
                  type="text"
                  placeholder="Search"
                  className="w-full bg-[#3c3c3c] border border-[#3c3c3c] focus:border-blue-500 rounded-sm px-2 py-1 outline-none text-[13px] text-[#cccccc]"
                />
                <input
                  type="text"
                  placeholder="Replace"
                  className="w-full bg-[#3c3c3c] border border-[#3c3c3c] focus:border-blue-500 rounded-sm px-2 py-1 outline-none text-[13px] text-[#cccccc] mt-2"
                />
              </div>
            )}
            {activeSidebar === "git" && (
                ...
                <div
                  ...
                  className={`flex items-center gap-2 px-3 py-1.5 min-w-[120px] max-w-[180px] border-r border-[#252526] border-t-2 cursor-pointer group ${
                    activeFile === file
                      ...
                      : "bg-[#2d2d2d] border-t-transparent text-[#969696] hover:bg-[#2b2b2b]"
                  }`}
                >
                  {files[file]?.icon}
                  ...
                  <div
                    ...
                    className={`flex items-center justify-center w-5 h-5 rounded hover:bg-[#333333] ${activeFile === file ? "opacity-100" : "opacity-0 group-hover:opacity-100"}`}
                  >
            ...
            <div className="h-[200px] bg-[#1e1e1e] border-t border-[#3c3c3c] flex flex-col flex-shrink-0">
              <div className="flex items-center justify-between px-4 h-[35px] cursor-default">
                <div className="flex space-x-6 text-[11px] uppercase tracking-wide">
                  <span className="text-[#858585] hover:text-[#cccccc] cursor-pointer">
                    Problems
                  </span>
                  <span className="text-[#858585] hover:text-[#cccccc] cursor-pointer">
                    Output
      ...
      <div className="h-[22px] bg-[#007acc] text-white flex items-center px-2 text-[12px] justify-between flex-shrink-0">
        <div className="flex items-center gap-3">
          <span className="flex items-center gap-1 hover:bg-white/20 px-1 rounded cursor-pointer transition-colors">
            <VscSourceControl className="text-[14px]" /> main
          </span>
          <span className="flex items-center gap-1 hover:bg-white/20 px-1 rounded cursor-pointer transition-colors">
            <VscClose className="text-[12px]" /> 0{" "}
            <VscBug className="text-[12px] ml-1" /> 0
          </span>
        </div>
        <div className="flex items-center gap-3">
          <span
          ...
          <span className="hover:bg-white/20 px-1 rounded cursor-pointer transition-colors">
            {activeFile
              ? files[activeFile]?.language === "jsx"
                ? "JavaScript React"
                : files[activeFile]?.language === "css"
                  ? "CSS"
                  : "JavaScript"
              : "Plain Text"}
          </span>
          <span className="hover:bg-white/20 px-1 rounded cursor-pointer transition-colors">
            <VscCheck className="text-[14px]" /> Prettier
          </span>
          <span className="hover:bg-white/20 px-1 rounded cursor-pointer transition-colors">
