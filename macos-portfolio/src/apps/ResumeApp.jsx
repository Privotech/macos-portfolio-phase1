      ...
      <div className="flex-1 p-8 flex justify-center">
        <div className="bg-white w-full max-w-[800px] min-h-[1131px] shadow-2xl text-black p-12 select-text">
          ...
          <section className="mb-8">
            <h3 className="text-lg font-bold text-gray-800 uppercase mb-3 border-b border-gray-200 pb-1">
              Summary
            </h3>
            <p className="text-gray-700 leading-relaxed text-sm">
              Creative and detail-oriented Software Engineer with a passion for
              crafting highly interactive and beautifully designed user
              interfaces. Specializing in React, modern JavaScript, and system
              architecture. Proven ability to build scalable web applications
              from scratch while maintaining exceptional code quality.
            </p>
          </section>

          <section className="mb-8">
            <h3 className="text-lg font-bold text-gray-800 uppercase mb-4 border-b border-gray-200 pb-1">
              Experience
            </h3>
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc list-outside ml-4 text-sm text-gray-700 space-y-1">
                <li>
                  Spearheaded the development of a flagship SaaS product using
                  React and Redux, improving user retention by 40%.
                </li>
                <li>
                  Mentored a team of 5 junior developers, conducting code
                  reviews and establishing best practices.
                </li>
                <li>
                  Reduced load times by 60% through aggressive code splitting
            ...
            <div className="mb-6">
              ...
              <ul className="list-disc list-outside ml-4 text-sm text-gray-700 space-y-1">
                <li>
                  Developed and deployed over 20 custom client websites using
                  Vue.js, React, and standard web technologies.
                </li>
                <li>
