      ...
      <div className="w-full max-w-4xl bg-white/5 border border-white/10 rounded-3xl p-8 flex flex-col md:flex-row gap-12 shadow-2xl">
        ...
        <div className="flex-1 space-y-8">
          <div>
            ...
            <p className="text-white/60">I'm currently looking for new opportunities. Whether you have a question or just want to say hi, I'll try my best to get back to you!</p>
          </div>

          <div className="space-y-4">
            <a href="mailto:hello@privotech.dev" className="flex items-center gap-4 text-white/80 hover:text-white transition-colors p-3 bg-white/5 rounded-xl border border-white/5 hover:border-white/20">
            ...
            <a href="#" className="flex items-center gap-4 text-white/80 hover:text-white transition-colors p-3 bg-white/5 rounded-xl border border-white/5 hover:border-white/20">
        ...
        <div className="flex-1 bg-black/40 p-6 rounded-2xl border border-white/5">
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div className="space-y-1">
              ...
              <input type="text" className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white outline-none focus:border-blue-500 transition-colors" placeholder="John Doe" />
            </div>
            <div className="space-y-1">
              <label className="text-xs font-semibold text-white/60 uppercase">Email</label>
              <input type="email" className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white outline-none focus:border-blue-500 transition-colors" placeholder="john@example.com" />
            </div>
            <div className="space-y-1">
              <label className="text-xs font-semibold text-white/60 uppercase">Message</label>
              <textarea rows="4" className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white outline-none focus:border-blue-500 transition-colors resize-none" placeholder="Hello..."></textarea>
            </div>
