...
const Window = ({ windowState }) => {
  ...
  const windowStyle = isMaximized
    ...
    : {
        ...
        height: `min(${size.height}px, calc(100vh - 28px - 70px))`,
      };
      ...
      >
        <AnimatePresence>
          {!isMinimized && (
            ...
            >
              <div
                className="window-handle h-10 bg-white/5 border-b border-white/10 flex items-center justify-between px-4 select-none relative"
              ...
              >
                <div className="flex space-x-2 absolute left-4 z-10 group">
                  ...
                  >
                    <span className="opacity-0 group-hover:opacity-100 text-[10px] text-black leading-none font-bold pb-px">
                      +
                    </span>
                  </button>
                </div>
